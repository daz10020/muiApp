//陈浩
//var myUrl = "http://192.168.51.114/api/"
//var imgUrl = "http://192.168.51.114/";
////gsm
//var myUrl = "http://192.168.51.119:81/api/";
//var imgUrl = "http://192.168.51.119:81/";
//曾超
//var myUrl = "http://192.168.51.115:81/api/"
//var imgUrl = "http://192.168.51.115:81/";
//服务器
var myUrl = "http://www.xiaonuo.club/api/"
var imgUrl = "http://www.xiaonuo.club/";
mui.init();
...
if(isWeiXin()) {
	$('header>a:first-child').css({
		'width': '38px',
		'height': '44px',
		'background': 'url(../image/3_1.png) no-repeat center center',
...
function showvalidopen(urls, param) {
	if(isWeiXin()) {
		if(localStorage.xnuid == null) {
